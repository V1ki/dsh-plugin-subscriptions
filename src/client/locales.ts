...
export const en = {
  ...
  usagePlan: 'Plan: {plan}',
  meterCaption: 'Plan usage limits',
  meterCaptionPlan: 'Plan usage limits · {plan}',
  meterAllModels: 'all models',
  meterEmpty: 'No usage data yet.',
  meterResetsIn: 'Resets in {duration}',
  meterResetsAt: 'Resets {date}',
  meterHours: '{count} hr',
  meterHoursMinutes: '{hours} hr {minutes} min',
  meterMinutes: '{count} min',
...
export const zh = {
  ...
  usagePlan: '计划：{plan}',
  meterCaption: '订阅用量上限',
  meterCaptionPlan: '订阅用量上限 · {plan}',
  meterAllModels: '全部模型',
  meterEmpty: '暂无用量数据。',
  meterResetsIn: '{duration}后重置',
  meterResetsAt: '{date} 重置',
  meterHours: '{count} 小时',
  meterHoursMinutes: '{hours} 小时 {minutes} 分',
  meterMinutes: '{count} 分',
  generating: '正在生成图片…',
  image: '图片',
  viewImage: '查看图片',
