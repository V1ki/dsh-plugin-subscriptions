...
export const en = {
  ...
  autoReviewNone: 'None',
  autoReviewNoneDescription: 'Use manual approvals',
  autoReviewProviderDescription: 'Review sandbox escalations automatically',
  autoReviewDefaultTitle: 'Default Auto-Review',
  autoReviewDefaultHint: 'The composer can override this per session; subagents inherit the nearest parent session choice.',
...
export const zh = {
  ...
  autoReview: '审批',
  autoReviewNone: '无',
  autoReviewNoneDescription: '使用手动审批',
  autoReviewProviderDescription: '自动审核沙箱提权请求',
  autoReviewDefaultTitle: '默认自动审批',
  autoReviewDefaultHint: '可在输入区按会话覆盖；子代理继承最近父会话的选择。',
  autoReviewDefaultLoading: '正在加载自动审批设置…',
  autoReviewDefaultSaving: '正在保存…',
  autoReviewDefaultLoadFailed: '自动审批设置加载失败：{message}',
  autoReviewDefaultSaveFailed: '自动审批设置保存失败：{message}',
